...
object StructuredStreaming {
   ...
   def main(args: Array[String]) {
      ...
      val spark = SparkSession
        ...
        .master("local[*]")
        .config("spark.sql.streaming.checkpointLocation", "/Users/atekade/learning-spark/struct-streams/")
        .getOrCreate()
        
      setupLogging()
        
      // Create a stream of text files dumped into the logs directory
      val rawData = spark.readStream.text("/Users/atekade/learning-spark/logs")
